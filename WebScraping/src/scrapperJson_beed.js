...
const url = "https://covidbeed.com/data/covidbeed.com/bed_data.json?_=f1d3163_2021050519163232323";
const urlShow = "https://covidbeed.com";
  ...
  axios(url)
    .then((response) => {
      ...
      for (let i = 0; i < response.data.length; i++) {
        ...
        dataObj["Phone"] = response.data[i].hospital_poc_phone;
