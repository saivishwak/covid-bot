...
const url = "https://covidaps.com/data/covidaps.com/bed_data.json?_=f1d3163_20210505191632323";
const urlShow = "https://covidaps.com";
  ...
  axios(url)
    .then((response) => {
      ...
      for (let i = 0; i < response.data.length; i++) {
        ...
        if (city == "east godavari") {
          city = "godavari";
        } else if (city == "west godavari") {
          city = "godavari";
        } else if (city == "y.s.r.") {
          city = "Ysrdistrict";
        } else if (city == "spsr nellore") {
          city = "nellore";
        } else if (city == "visakhapatanam") {
          city = "visakhapatnam";
        }
        ...
        if (response.data[i].hospital_phone[0] == "<") {
          dataObj["Phone"] = "N/A";
        }
        dataObj["Location"] = response.data[i].hospital_address != null ? response.data[i].hospital_address : "N/A";
