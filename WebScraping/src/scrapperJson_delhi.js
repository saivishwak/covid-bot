...
const url = "https://coviddelhi.com/data/coviddelhi.com/bed_data.json?_=f1d3163_20210505191632323";
const urlShow = "https://coviddelhi.com";
  ...
  axios(url)
    .then((response) => {
      ...
      for (let i = 0; i < response.data.length; i++) {
        ...
        dataObj["ICU Beds"] = "N/A";
        dataObj["Oxygen Beds"] = "N/A";
        dataObj["Regular Beds"] = response.data[i].available_beds_allocated_to_covid;
        dataObj["Last Checked"] = moment(response.data[i].last_updated_on).format("MMMM Do YYYY, h:mm a");
